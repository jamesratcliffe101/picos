...
#define LCD_SCK 10 // serial clock (SCL)
#define LCD_TX  11 // serial data in (SDI)
#define LCD_RX  12 // serial data out (SDO)
#define LCD_CS  13 // chip select (CSX)
#define LCD_DC  14 // data/command (D/CX)
...
#define SPI_PORT spi1 // SPI interface for the LCD display
